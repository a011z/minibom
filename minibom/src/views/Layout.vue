          ...
          <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
            <el-menu :default-openeds="['1', '2']">
              ...
              <el-menu-item index="1-2"
                ><router-link to="/attribute" title="属性管理"
                  >属性管理</router-link
                ></el-menu-item
              >
            </el-menu>
        ...
        <el-main style="padding-top: 0px">
          ...
          <el-table :data="tableData" style="margin-top: 0px">
            ...
            <el-table-column #default="{ row }" label="操作">
              ...
              <el-button
                ...
                @click="
                  handleRowClick(row);
                  getParentList(row.partId);
                  getSubPartList(row.versionId);
                  addSubpartModel.sourceId = row.partId;
                  setVersionId(row.versionId);
                  seleteIdForTree(row.partId);
                  getVersionList(row.partId);
                "
                >修改</el-button
              >
              <el-button
          ...
          <el-dialog title="" v-model="dialogFormVisible">
              ...
              <el-tabs type="border-card">
                ...
                <el-tab-pane label="BOM清单">
                  <div>
                    ...
                    <!-- 直接跳转到BOM页面 -->
                    <el-button plain @click="bomListView()"
                      >查看BOM清单</el-button
                    >
                    <el-button plain @click="dialogVisible3 = true"
                      >查看父项</el-button
                    >
                ...
                >
                    ...
                    <el-table :data="partModel" style="margin-top: 0px">
                      ...
                      <el-table-column label="" width="200">
                        <template #default="{ row }">
                          ...
                          <el-button
                            :class="{
                              'default-style': !row.isActive,
                              'active-style': row.isActive,
                            }"
                            @click="postTargetId(row)"
                            >添加选定项</el-button
                          >
                        </template>
                      </el-table-column>
                  ...
                  <div>
                    ...
                    <el-form-item label="位号">
                      <el-input
                        v-model="partModel.referenceDesignator"
                      ></el-input>
                    </el-form-item>
                  </div>
                  ...
                  <template #footer>
                    <span class="dialog-footer">
                      <el-button
                        type="primary"
                        @click="
                          addSubpartModel.quantity = partModel.quantity;
                          addSubpartModel.referenceDesignator =
                            partModel.referenceDesignator;
                          addSubpartApi();
                        "
                        >确认</el-button
                      >
                ...
                >
                  ...
                  >
                    ...
                    <el-form-item label="位号" prop="referenceDesignator">
                      <el-input
                        v-model="subPartModel.referenceDesignator"
                        minlength="1"
                        maxlength="15"
                      ></el-input>
                    </el-form-item>
                  ...
                  <template #footer>
                    <span class="dialog-footer">
                      <el-button @click="dialogVisible2 = false"
                        >取消</el-button
                      >
                      <el-button type="primary" @click="updateSubPart">
                        确认
                      </el-button>
                    </span>
                  </template>
            ...
            <template v-slot:footer>
              <div class="dialog-footer">
                ...
                <el-button type="primary" @click="updatePart(form)"
                  >提交</el-button
                >
              </div>
            </template>
          ...
          <el-dialog v-model="showAdd" title="创建新的部件">
            ...
            <template #footer>
              ...
              <el-button type="primary" @click="addPart(addform)"
                >提交</el-button
              >
            </template>
          </el-dialog>
...
import {
  ...
  subPartListService,
  AddSubpartService,
  subPartUpdateService,
  subPartDeleteService,
  parentListService,
  bomListService,
  versionListService,
} from "../api/layout";
...
const deleteSubPart = (row) => {
  //提升用户 确认框
  ElMessageBox.confirm("你确认要删除该bom信息吗", "温馨提示", {
...
const getcls = (e) => {
  ...
  request
    .get(`/part/ClassificationNode/getCategoryNodeInfo?id=${businessCode1}`)
    .then((result) => {
      console.log(result);
...
const deletePart = (row) => {
  ElMessageBox.confirm("你确认要删除该part吗", "温馨提示", {
    confirmButtonText: "确认",
    cancelButtonText: "取消",
    type: "warning",
  })
    .then(async () => {
      console.log(row),
        request.delete(`/part/delete/${row.partId}`).then((result) => {
...
const updatePart = (row) => {
  //调用checkout
  request.put("/part/checkout?id=" + row.partId, {}).then(async (result) => {
    console.log(result);
    console.log(158);
    form.partId = row.partId;
    form.partNumber = row.partNumber;
  ...
  request
    ...
    .then((result) => {
      ...
      if (result.code === 20031) {
        ...
        ElMessage.error(result.message);
        request
          .put("/part/undoCheckout?id=" + row.partId, {})
          .then((result) => {
            console.log(result);
          });
      }
      ...
      request
        .post("/part/query", {
          partNumber:
            searchForm.partNumber === "" ? null : searchForm.partNumber,
          partName: searchForm.partName === "" ? null : searchForm.partName,
        })
        .then((result) => {
          console.log(result);
